...
export class AztecGateway7683Contract extends ContractBase {
  ...
  public static get storage(): ContractStorageLayout<
    "config" | "claimable_orders" | "open_orders" | "order_status" | "used_nonces" | "orders_settlement_block_numbers"
  > {
    return {
      config: {
        slot: new Fr(1n),
  ...
  declare public methods: {
    ...
    get_order_settlement_block_number: ((order_id_bytes: (bigint | number)[]) => ContractFunctionInteraction) &
      Pick<ContractMethod, "selector">
