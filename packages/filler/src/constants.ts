...
export const FORWARDER_CHAIN_ID = parseInt(config.evm.forwarderChainId)
...
export const FORWARDER_ADDRESS = config.forwarderAddress
export const OP_STACK_ANCHOR_REGISTRY_ADDRESS = config.evm.opStackAnchorRegistryAddress
export const AZTEC_ROLLUP_CONTRACT_L1_ADDRESS = config.evm.aztecRollupContractL1Address
export const IS_SANDBOX_ENV = config.aztec.isSandbox
